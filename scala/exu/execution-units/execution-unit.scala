 ...
 */
class ExeUnitResp(val dataWidth: Int)(implicit p: Parameters) extends BoomBundle          //执行单元的响应
  with HasBoomUOP
{
  ...
  )(implicit p: Parameters) extends BoomModule
{
  ...
  val io = IO(new Bundle {
    ...
    val data_check_unpass    = if (writesIrf)  Output(Bool())  else null           //data_check_unpass
